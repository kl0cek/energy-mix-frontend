  ...
  return (
    <div className={`${theme === 'dark' ? 'bg-sky-950 text-slate-200' : 'bg-white text-gray-900'} rounded-lg shadow-md p-6`}>
      ...
      <div className="space-y-3">
        <div className={`border ${theme === 'dark' ? 'border-blue-600' : 'border-blue-400'} rounded-lg p-4`}>
          <p className={`text-sm mb-1 ${theme === 'dark' ? 'text-slate-300' : 'text-gray-600'}`}>Okno ładowania</p>
        ...
        <div className={`border ${theme === 'dark' ? 'border-blue-600' : 'border-blue-400'} rounded-lg p-4`}>
          <p className={`text-sm mb-1 ${theme === 'dark' ? 'text-slate-300' : 'text-gray-600'}`}>Średni udział czystej energii</p>
          <p className={`text-3xl font-bold ${theme === 'dark' ? 'text-green-500' : 'text-green-600'}`}>
